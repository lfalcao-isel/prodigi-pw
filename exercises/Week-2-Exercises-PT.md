...
2. Criar o ficheiro `app.js` ou `server.js` com o código da API

3. Implementar as rotas especificadas

4. Testar a API usando um navegador ou ferramenta como Postman/cURL
